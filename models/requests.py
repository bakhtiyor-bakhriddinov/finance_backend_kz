...
class Requests(Base):
    ...
    acceptance_number = Column(String)
    # sap_code = Column(String)
    invoice_sap_code = Column(String)
    contract_number = Column(String)
    approved = Column(Boolean, default=False)
    credit = Column(Boolean, default=False)
    purchase_approved = Column(Boolean, nullable=True)
    checked_by_financier = Column(Boolean, nullable=True)
